...
namespace SolutionCleaner
{
    ...
    [Guid(SolutionCleanerPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    public sealed class SolutionCleanerPackage : Package
    {
        /// <summary>
        /// SolutionCleanerPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "c53fd02b-f57b-424a-895e-964d95aa7a12";

        /// <summary>
        /// Initializes a new instance of the <see cref="SolutionCleanerPackage"/> class.
        /// </summary>
        public SolutionCleanerPackage()
        {
